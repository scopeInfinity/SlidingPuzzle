...
use crate::io::GameInputHandler;
use crate::io::GameOutputHandler;
...
impl ConsoleInputHandler {
    pub fn new(stdin: std::io::Stdin) -> ConsoleInputHandler {
        ConsoleInputHandler { stdin }
    }
}
impl GameInputHandler for ConsoleInputHandler {
...
impl ConsoleOutputHandler {
    pub fn new(stdout: std::io::Stdout) -> ConsoleOutputHandler {
        ConsoleOutputHandler {
            stdout: stdout.into_raw_mode().unwrap(),
        }
    }
}
impl GameOutputHandler for ConsoleOutputHandler {
